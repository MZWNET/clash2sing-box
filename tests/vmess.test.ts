...
import type { ClashProxyVmess } from "../src/libs/types.ts";
import { doConvertVmess } from "../src/libs/converters/vmess.ts";
...
describe("doConvertVmess", () => {
  it("converts basic fields: name → tag, server, port, uuid", () => {
    const result = doConvertVmess(makeVmessProxy());
