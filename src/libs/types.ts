...
const ClashProxy = z.object({
  ...
  "ip-version": z.optional(z.enum(["dual", "ipv4", "ipv6", "ipv4-prefer", "ipv6-prefer"])),
});
...
const SingboxOutboundCommonDomainResolver = z.object({
  server: z.string(),
  strategy: z.optional(z.enum(["prefer_ipv4", "prefer_ipv6", "ipv4_only", "ipv6_only"])),
});
...
export const SingboxOutboundHysteria2 = SingboxOutbound.extend({
  ...
  tls: z.optional(
    SingboxOutboundCommonTlsTransport.extend({
      reality: z.optional(
        z.object({
          enabled: z.boolean(),
          public_key: z.string(),
