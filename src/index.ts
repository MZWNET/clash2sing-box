...
void new Command()
  ...
  .option(
    '--outbound-selector-default <integer>',
  ...
  .action((input: string[], options: Record<string, unknown>) => {
    ...
    if (options['outboundDomainresolverTag'] !== undefined || options['outboundSelectorDefault'] !== undefined || options['outboundSelectorTag'] !== undefined) {
      opts.outbound = {}
